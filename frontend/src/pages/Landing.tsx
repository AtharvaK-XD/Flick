      ...
      <main className="max-w-6xl mx-auto px-6 pt-40 md:pt-48 lg:pt-56 flex-1 flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="pt-2">
            <button
              onClick={handleCTA}
              className="inline-flex items-center gap-3 border border-[var(--border)] hover:border-[var(--border-hover)] bg-surface hover:bg-surface-2 active:scale-[0.98] text-sm font-medium px-6 py-3 rounded-lg transition-all duration-200 cursor-pointer"
            >
        ...
        >
          ...
          >
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-full max-w-[500px] bg-surface/50 border border-[var(--border)] p-5 rounded-2xl flex items-center justify-center">
                <FlipCard
          ...
          >
            ...
            <div className="flex justify-center lg:justify-start">
              <div className="w-full max-w-[500px] bg-surface border border-[var(--border)] rounded-xl p-5 font-sans space-y-4 text-xs select-none">
                ...
                <div className="h-20 bg-app border border-[var(--border)] rounded-lg p-3 text-[var(--text-muted)] italic text-left">
                  Paste notes here...
                </div>
                <div className="flex justify-between items-center bg-app border border-[var(--border)] rounded-lg p-1">
          ...
          >
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="w-full max-w-[500px] bg-surface border border-[var(--border)] p-5 rounded-xl space-y-4 text-xs font-mono select-none">
