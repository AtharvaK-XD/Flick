    ...
    <DashboardLayout>
      <PageWrapper className="space-y-10">
        ...
        <div className="space-y-4 pt-4 border-t border-white/5 text-left">
          ...
          <div className="bg-surface border border-[var(--border)] rounded-xl divide-y divide-[var(--border)] overflow-hidden">
            {recentActivities.slice(0, 3).map((activity) => (
              <div 
                key={activity.id}
                className="px-5 py-4 flex items-center justify-between text-xs hover:bg-surface-2 transition-colors"
              >
