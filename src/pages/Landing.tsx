      ...
      <main className="max-w-6xl mx-auto px-6 pt-40 md:pt-48 lg:pt-56 flex-1 flex flex-col justify-center items-center text-center relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="pt-2">
            <button
              onClick={handleCTA}
              className="inline-flex items-center gap-3 border border-white/10 hover:border-white/20 bg-[#161618] hover:bg-[#1E1E22] active:bg-black/20 active:scale-[0.98] text-sm font-medium px-6 py-3 rounded-lg transition-all duration-200 cursor-pointer"
            >
